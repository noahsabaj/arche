...
**Current focus:** M23 native ECS world storage bridge is active; M23-003 is Ready.
...
| M23-002 materialized decoded startup spawn rows into native storage; M23-003 and M23-004 continue the bridge through query planning and compiled `Demo.Move` execution | 96/100 |
...
| Ready contains only M23-003 and Backlog contains only M23-004 through M23-005, preserving the one-proof-at-a-time board cadence | 98/100 |
