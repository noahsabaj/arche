...
use super::shape::{
    encode_symbolic_declaration_shape_skeleton_c1,
    encode_symbolic_definition_owner_skeleton_c1, encode_target_root, DeclarationKind,
    ShapeEncodingError, SymbolicDeclarationShapeSkeleton, SymbolicDefinitionOwnerSkeleton,
    TargetRoot,
};
...
mod tests {
    ...
    fn mandatory_corpora_inventory_bytes_are_complete_and_exact() {
        ...
        assert_eq!(lengths, vec![131_914, 170_863]);
        assert_eq!(
            digest,
            [
                0xca, 0x21, 0x42, 0xc6, 0x50, 0x85, 0x68, 0x65, 0x5e, 0xde, 0xde, 0x41, 0x39, 0x63,
                0x5c, 0x2f, 0xcf, 0xdc, 0xb2, 0xe1, 0x0c, 0x5c, 0x15, 0x70, 0x80, 0xf8, 0x5c, 0x30,
                0xfc, 0x1c, 0xa6, 0x08,
            ]
        );
    }
