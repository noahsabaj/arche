...
pub use hir::{
    ...
    try_canonicalize_definition_owner, AssociatedPathCandidate, AssociatedPathOwner,
    AssociatedPathResolution, BuiltinRes, BuiltinResTarget, C2ContextualSelfTypeTemplate,
    C2TypeTemplateBlocker, C2TypeTemplateInstantiationError, C2TypeTemplateLookupError, CallTrait,
