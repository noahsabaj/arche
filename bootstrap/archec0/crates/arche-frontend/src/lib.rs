...
pub use hir::{
    ...
    encode_semantic_definition_key_session, encode_symbolic_const, encode_symbolic_effect,
    encode_symbolic_effect_set, encode_symbolic_predicate, encode_symbolic_predicate_set,
    encode_symbolic_type, owner_shape_readiness, try_canonicalize_declaration_shape,
