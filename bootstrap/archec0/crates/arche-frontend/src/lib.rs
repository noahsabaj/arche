...
pub use hir::{
    ...
    encode_declaration_shape_preimage, encode_definition_identity_preimage,
    encode_definition_owner_entry, encode_final_declaration_shape_identity,
    encode_final_definition_owner_identity, encode_generic_arguments, encode_generic_parameters,
    encode_inventory_c1, encode_method_entry, encode_semantic_definition_key_session,
    ...
    mint_definition_id, owner_shape_readiness, symbolic_predicate_readiness,
    symbolic_type_readiness, try_canonicalize_declaration_shape, try_canonicalize_definition_owner,
    AssociatedPathCandidate, AssociatedPathOwner, AssociatedPathResolution, BuiltinRes,
    BuiltinResTarget, C2ContextualSelfTypeTemplate, C2TypeTemplateBlocker,
    C2TypeTemplateInstantiationError, C2TypeTemplateLookupError, CallTrait,
    ...
    HirSelfUse, IntegerType, LocalId, ManifestCapability, MaterializedRegistryPackage,
    MemberVisibilityPath, ModuleId, ModuleRef, Mutability, Namespace, PackageDependencySkeleton,
    PackageProvenanceSkeleton, PackageSourceSkeleton, PathResolution, PendingShapeKind, Res,
    ResolvedGenericArgument, ResolvedSymbolicBody, ResolvedSymbolicConst, ResolvedSymbolicEffect,
    ResolvedSymbolicItem, ResolvedSymbolicLifetime, ResolvedSymbolicModule,
