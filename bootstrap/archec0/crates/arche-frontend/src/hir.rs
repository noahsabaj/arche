...
pub use self::shape::{
    ...
    encode_method_entry, encode_symbolic_const, encode_symbolic_effect, encode_symbolic_effect_set,
    encode_symbolic_predicate, encode_symbolic_predicate_set, encode_symbolic_type,
    owner_shape_readiness, try_canonicalize_declaration_shape,
    ...
    SemanticDeclarationPath, ShapeEncodingError, SymbolicCallableKind,
    ...
    SymbolicVariantShapeSkeleton, TargetRoot,
};
pub use self::workspace_frontend::{
    ...
    HiddenLifetimeBinder,
    HiddenLifetimeBinderSource, HirBinding, HirBindingOrigin, HirBindingTarget, HirBodySource,
    HirGenericArgumentUse, HirGenericArgumentsUse, HirItemRes, HirItemSource, HirLocalBinding,
    HirPathUse, HirSelfUse, LocalId, PathResolution, Res, ResolvedGenericArgument,
