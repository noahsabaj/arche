...
fn trait002_integer_logical_not_is_a_terminal_c2_rejection() {
    assert_terminal_rejection(ExpectedCase {
        ...
        phase: CompilationPhase::BodyCallOperatorPattern,
        code: "TRAIT002",
        message: "no primitive Unary(LogicalNot) selection for left=U32, right=None, result=U32",
        start_byte: 25,
        start_line: 1,
        start_column: 26,
        end_byte: 30,
...
fn trait002_mixed_step_scalars_is_a_terminal_c2_rejection() {
    assert_terminal_rejection(ExpectedCase {
        ...
        phase: CompilationPhase::BodyCallOperatorPattern,
        code: "TRAIT002",
        message: "no primitive AddAssignment selection for left=I64, right=Some(U32), result=I64",
        start_byte: 47,
        start_line: 2,
        start_column: 5,
        end_byte: 60,
